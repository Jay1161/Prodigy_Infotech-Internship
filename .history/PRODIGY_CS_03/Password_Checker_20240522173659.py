...
progress_bar.grid(row=3, columnspan=2, padx=10, pady=5)
suggestions_label.grid(row=4, columnspan=2, padx=10, pady=5)
crack_time_label.grid(row=5, columnspan=2, padx=10, pady=5)
